...
# Select relevant feature columns for LSTM
selected_features = [
...
X_train.to_csv('../../data/prepare_lstm_training_data/processed_X_train.csv', index=False)
X_test.to_csv('../../data/prepare_lstm_training_data/processed_X_test.csv', index=False)
y_train.to_csv('../../data/prepare_lstm_training_data/processed_y_train.csv', index=False)
y_test.to_csv('../../data/prepare_lstm_training_data/processed_y_test.csv', index=False)

logging.info('Prepared datasets saved to processed directory.')
logging.info('Data preparation for LSTM training completed successfully.')
